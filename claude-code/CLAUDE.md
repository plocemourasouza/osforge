...
OSForge ships **170 skills**, **27 agents** (orchestrator + 26 specialists), **13** always-on **rules**,
...
- **🔒 Cacheable prefix (stable):** identity + safety (this file, top), `settings.json` (permissions/hooks),
  style rules (`typescript-strict.mdc`, `code-style.mdc`, `anti-ai-slop.mdc`), the skills index (`@SKILLS.md`, 170 skills).
