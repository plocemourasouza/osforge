...
|------|--------|--------------|
| [references/ux-psychology.md](references/ux-psychology.md) | **REQUIRED** | Always read first! |
| [references/color-system.md](references/color-system.md) | Optional | Color/palette decisions |
| [references/typography-system.md](references/typography-system.md) | Optional | Font selection/pairing |
| [references/visual-effects.md](references/visual-effects.md) | Optional | Glassmorphism, shadows, gradients |
| [references/animation-guide.md](references/animation-guide.md) | Optional | Animation needed |
| [references/motion-graphics.md](references/motion-graphics.md) | Optional | Lottie, GSAP, 3D |
| [references/decision-trees.md](references/decision-trees.md) | Optional | Context templates |
...
For detailed color theory: [references/color-system.md](references/color-system.md)
...
For detailed typography: [references/typography-system.md](references/typography-system.md)
...
For complete effects guide: [references/visual-effects.md](references/visual-effects.md)
...
For animation patterns: [references/animation-guide.md](references/animation-guide.md), for advanced: [references/motion-graphics.md](references/motion-graphics.md)
...
- [references/color-system.md](references/color-system.md) - Color theory and selection process
- [references/typography-system.md](references/typography-system.md) - Font pairing and scale decisions
- [references/visual-effects.md](references/visual-effects.md) - Effects principles and techniques
- [references/animation-guide.md](references/animation-guide.md) - Motion design principles
- [references/motion-graphics.md](references/motion-graphics.md) - Advanced: Lottie, GSAP, SVG, 3D, Particles
- [references/decision-trees.md](references/decision-trees.md) - Context-specific templates
- [references/ux-psychology.md](references/ux-psychology.md) - User psychology deep dive
...
## Next.js 16+ Modern Form Patterns
