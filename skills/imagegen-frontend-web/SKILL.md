...
description: "Art direction for generating premium site mockups via image generation: one separate horizontal image per section, hero composition variety, and a single consistent palette across all images. Use when: 'generate reference images of the landing page design', 'create visual mockups of the site section by section', 'I want to see how the site would look before coding', 'generate a design comp for the dev to recreate', 'inspiration image for the hero, pricing, or footer'. Keywords: image, image generation, mockup, design reference, comp, landing page, hero, sections, art direction, website concept. Do NOT use for: writing actual frontend code (high-end-visual-design, gpt-taste), mobile app mockups (imagegen-frontend-mobile), brand boards and logos (brandkit), DESIGN.md generation (stitch-design-taste)."
---
