---
name: gpt-taste
description: "Engenharia de design award-winning com motion GSAP avançado: randomização de layouts, estrutura AIDA, hero de no máximo 2-3 linhas, bento grids sem células vazias e ScrollTrigger com pinning, scrubbing e card stacking. ACIONE quando: 'landing page nível Awwwards com animações de scroll', 'adiciona GSAP ScrollTrigger com seções pinned', 'bento grid sem buracos vazios', 'o hero está quebrando em 6 linhas, conserta', 'scroll telling com texto revelando ao rolar'. Keywords: GSAP, ScrollTrigger, awwwards, bento grid, AIDA, scroll telling, pinning, scrubbing, hero, marquee. Não acione para: polimento premium sem GSAP (high-end-visual-design), interfaces minimalistas (minimalist-ui), geração de DESIGN.md para Stitch (stitch-design-taste), gerar mockups de sites via imagem (imagegen-frontend-web)."
---
