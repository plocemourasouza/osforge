---
name: brandkit
description: "Gera imagens de brand-kit premium: boards de brand guidelines, sistemas de logo, identity decks e apresentações de universo visual com grids limpos, tipografia esparsa e metáfora de marca forte. ACIONE quando: 'cria um brand kit para minha startup', 'gera a identidade visual e o logo system da marca', 'monta um board de brand guidelines estilo estúdio', 'preciso de um deck de identidade com logo, paleta e mockups', 'cria o universo visual da marca'. Keywords: brand kit, identidade visual, logo, branding, guidelines, identity deck, marca, visual system, moodboard, apresentação. Não acione para: design de UI e sites (minimalist-ui, high-end-visual-design), mockups de páginas web seção por seção (imagegen-frontend-web), geração de DESIGN.md para Stitch (stitch-design-taste)."
---
