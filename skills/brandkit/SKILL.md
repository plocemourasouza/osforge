---
name: brandkit
description: "Generates premium brand-kit images: brand guideline boards, logo systems, identity decks, and visual-universe presentations with clean grids, sparse typography, and a strong brand metaphor. Use when: 'create a brand kit for my startup', 'generate the brand's visual identity and logo system', 'put together a studio-style brand guidelines board', 'I need an identity deck with logo, palette, and mockups', 'create the brand's visual universe'. Keywords: brand kit, visual identity, logo, branding, guidelines, identity deck, brand, visual system, moodboard, presentation. Do NOT use for: UI and website design (minimalist-ui, high-end-visual-design), section-by-section web page mockups (imagegen-frontend-web), DESIGN.md generation for Stitch (stitch-design-taste)."
---
